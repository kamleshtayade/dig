...
.directive("solrFacetGroup", function() {
  return {
    ...
    transclude: true,
    templateUrl:"app/views/solr/solr_facet_group.html",
...
.directive("solrSelected", function(){
  return {
    ...
    transclude: true,
    templateUrl: "app/views/solr/solr_selected.html",
    require:"^solr",
...
.directive("solrSearch", function($location) {
  return {
    ...
    restrict: "E",
    templateUrl:"app/views/solr/solr_search.html",
    require: "^solr",
    link: function( scope, element, attrs, ctrl){
...
.directive("solrFacet", function() {
  return {
    ...
    templateUrl:"app/views/solr/solr_facet.html",
    link: function( scope, element, attrs, ctrl){
...
.directive("solrFacetResult", function($location) {
  return {
    ...
    require: "^solr",
    templateUrl:"app/views/solr/solr_facet_result.html",
    link: function( scope, element, attrs, ctrl){
